...
public class PartidaRapidax5 extends Activity{
	...
	public void chamaTorneio() {
		...
		voltar.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(PartidaRapidax5.this,
	...
	public void ganhou() {
		jogador=0;
		pc=0;
		AlertDialog.Builder dialogo = new AlertDialog.Builder(PartidaRapidax5.this);
